...
class UserNotificationConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        # TODO:  the generated string from the user instance is dependent on the user logging in with an email (fix bug!)
    ...
    def get_notification(self, pk):
        ...
        # TODO:  ensure that the proper exceptions are the ones been catch in try-exceptions blocks
        except Exception:
            pass
        finally:
            return notification
