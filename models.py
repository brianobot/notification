from config.models import TimeStampedMixin
...
class Notification(TimeStampedMixin):
    ...
    # TODO:  implement a field to hold the topic of the notification which would a name specifying the action the notification is about
